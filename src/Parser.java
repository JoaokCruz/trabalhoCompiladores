...
public class Parser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\030\000\004\012\004\001\002\000\012\011\011\014" +
    "\013\017\012\020\010\001\002\000\004\002\001\001\002" +
    "\000\004\002\007\001\002\000\004\002\000\001\002\000" +
    "\020\004\ufff7\005\ufff7\006\ufff7\007\ufff7\010\ufff7\013\ufff7" +
    "\015\ufff7\001\002\000\012\011\011\014\013\017\012\020" +
    "\010\001\002\000\020\004\ufff6\005\ufff6\006\ufff6\007\ufff6" +
    "\010\ufff6\013\ufff6\015\ufff6\001\002\000\012\011\011\014" +
    "\013\017\012\020\010\001\002\000\016\004\015\005\021" +
    "\006\016\007\022\010\017\013\020\001\002\000\012\011" +
    "\011\014\013\017\012\020\010\001\002\000\012\011\011" +
    "\014\013\017\012\020\010\001\002\000\020\004\ufffb\005" +
    "\ufffb\006\ufffb\007\ufffb\010\ufffb\013\ufffb\015\ufffb\001\002" +
    "\000\004\017\025\001\002\000\012\011\011\014\013\017" +
    "\012\020\010\001\002\000\012\011\011\014\013\017\012" +
    "\020\010\001\002\000\020\004\ufffa\005\ufffa\006\ufffa\007" +
    "\ufffa\010\017\013\ufffa\015\ufffa\001\002\000\020\004\ufffd" +
    "\005\ufffd\006\016\007\022\010\017\013\ufffd\015\ufffd\001" +
    "\002\000\004\002\uffff\001\002\000\020\004\ufffc\005\ufffc" +
    "\006\ufffc\007\ufffc\010\017\013\ufffc\015\ufffc\001\002\000" +
    "\020\004\ufffe\005\ufffe\006\016\007\022\010\017\013\ufffe" +
    "\015\ufffe\001\002\000\016\004\015\005\021\006\016\007" +
    "\022\010\017\015\031\001\002\000\020\004\ufff8\005\ufff8" +
    "\006\ufff8\007\ufff8\010\ufff8\013\ufff8\015\ufff8\001\002\000" +
    "\020\004\ufff9\005\ufff9\006\ufff9\007\ufff9\010\017\013\ufff9" +
    "\015\ufff9\001\002" });
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\030\000\006\002\005\003\004\001\001\000\004\004" +
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Parser$act_num)
		...
		RESULT = start_val;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 2: // exp ::= GUARDAR expMat EM ID 
            {
              Object RESULT =null;
		...
		Object i = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 simbolos.put(i.toString(), e); RESULT = e; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 3: // expMat ::= expMat MAIS expMat 
            {
              Integer RESULT =null;
		...
		Integer e2 = (Integer)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = e1+e2;                  
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 4: // expMat ::= expMat MENOS expMat 
            {
              Integer RESULT =null;
		int e1left = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).left;
		int e1right = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).right;
		...
		Integer e2 = (Integer)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = e1-e2;                  
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 5: // expMat ::= expMat VEZES expMat 
            {
              Integer RESULT =null;
		int e1left = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).left;
		int e1right = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).right;
		...
		Integer e1 = (Integer)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 RESULT = e1*e1;                  
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 7: // expMat ::= expMat DIV expMat 
            {
              Integer RESULT =null;
		int e1left = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).left;
		int e1right = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).right;
